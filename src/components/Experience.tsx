  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        {/* ========================================================================= */}
        {/* OPEN CINEMATIC TIMELINE (Pure CSS 120 FPS Zero-Lag Architecture)          */}
        {/* ========================================================================= */}
        <div className="relative mb-28">
          ...
          <div className="hidden md:block relative">
            ...
            {/* Radiant Golden Laser Line Beam (Pure GPU Layer) */}
            <div
              className="absolute left-[190px] lg:left-[210px] top-4 bottom-4 w-[2px] bg-gradient-to-b from-amber-400 via-accent-orange to-amber-500 rounded-full shadow-[0_0_16px_rgba(245,158,11,0.85),0_0_30px_rgba(249,115,22,0.45)] pointer-events-none"
              aria-hidden="true"
            />
            ...
            <div className="space-y-16 lg:space-y-24">
              {timelineMilestones.map((item) => (
                <div
                  key={item.id}
                  className="grid grid-cols-[190px_1fr] lg:grid-cols-[210px_1fr] gap-0 items-start group relative"
                >
                  {/* Left Column: Date / Year Tag (Right-Aligned to the Golden Line) */}
                  <div className="pr-8 lg:pr-10 text-right pt-1 select-none">
                    <div className="font-mono text-[0.92rem] lg:text-[1.0rem] font-bold text-zinc-300 tracking-wider uppercase group-hover:text-amber-400 group-hover:drop-shadow-[0_0_10px_rgba(251,191,36,0.6)] transition-colors duration-200">
                      {item.year}
                    </div>
                  ...
                  <div className="absolute left-[190px] lg:left-[210px] top-2 -translate-x-1/2 z-20 flex items-center justify-center pointer-events-none">
                    <div className="w-6 h-6 rounded-full bg-[#09090b] border-2 border-amber-400/80 group-hover:border-amber-400 group-hover:scale-125 group-hover:shadow-[0_0_20px_rgba(251,191,36,0.95),0_0_35px_rgba(249,115,22,0.5)] transition-all duration-200 flex items-center justify-center">
                  ...
                  <div className="pl-8 lg:pl-10">
                    ...
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <h3 className="font-display text-[1.45rem] sm:text-[1.8rem] lg:text-[2.15rem] font-black text-white uppercase tracking-[0.02em] leading-tight group-hover:text-amber-400 transition-colors duration-200">
                        {item.title}
                      </h3>
                      {item.badge && (
          ...
          <div className="block md:hidden relative pl-6">
            ...
            {/* Mobile Laser Beam */}
            <div
              className="absolute left-[11px] top-3 bottom-3 w-[2px] bg-gradient-to-b from-amber-400 via-accent-orange to-amber-500 rounded-full shadow-[0_0_14px_rgba(245,158,11,0.85)]"
              aria-hidden="true"
            />
